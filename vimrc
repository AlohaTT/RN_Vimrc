...
" tab length exceptions on some file types
 autocmd FileType html setlocal shiftwidth=4 tabstop=4 softtabstop=4 smartindent
 autocmd FileType htmldjango setlocal shiftwidth=4 tabstop=4 softtabstop=4 smartindent
 autocmd FileType javascript setlocal shiftwidth=4 tabstop=4 softtabstop=4 smartindent
...
autocmd BufNewFile *.sh,*.py,*.rb,*.js exec ":call SetTitle()"
function SetTitle()
    if &filetype == 'sh'
    ...
    elseif expand("%:e") == "js"
        ...
        call append(3," * Created by Tony on ".strftime("%Y/%m/%d"))
        call append(4," */")
        call append(5,"")
